...
def import_data(bot: Bot, update):
	...
	if msg.reply_to_message and msg.reply_to_message.document:
		...
		try:
			...
			return msg.reply_text("There is problem while importing the data! Please ask in @BHZBot_Support about why this happened.")
		...
		try:
			...
			msg.reply_text("An error occurred while recovering your data. The process failed. If you experience a problem with this, please ask in @BHZBot_Support . My owner and community will be happy to help. Also, bugs report makes me even better!\nThank you!")
